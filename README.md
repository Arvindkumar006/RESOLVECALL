...
[OK] Ingested Incident: INC-202609-001
     Vendor: Regional Freight Lines | Phone: +18005550199
...
[INFO] AUDIT [INC-202609-001] CALL_PLANNED: CALL-E call planned successfully (Plan ID: pWT3G30PT).
[INFO] AUDIT [INC-202609-001] CALL_INITIATED: Initiating real-time PSTN phone call to +18005550199 via CALL-E.
[INFO] Executing CALL-E run for plan pWT3G30PT
[INFO] AUDIT [INC-202609-001] CALL_RUNNING: Call run active with CALL-E network (Run ID: ssdpfI6fI1u0CWtkjb1Z0Q).
...
* **CALL-E Production MCP Broker**: `https://seleven-mcp-sg.airudder.com/mcp/openagent_oauth`
* **Verified Plan ID**: `pWT3G30PT`
* **Verified Call Run ID**: `ssdpfI6fI1u0CWtkjb1Z0Q`
* **Verified PSTN Carrier Call ID**: `65b4a01aa64f4f2a8d9954e7c1b61067`
